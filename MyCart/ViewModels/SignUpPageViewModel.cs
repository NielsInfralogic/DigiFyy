...
namespace DigiFyy.ViewModels
{
    ...
    /// </summary>
    public class SignUpPageViewModel : LoginViewModelBase
    {
        #region Fields
        ...
        /// </summary>
        public SignUpPageViewModel(INavigationService navigationService, IAnalyticsService analyticsService, IDialogService dialogService) : base(navigationService, analyticsService)
        {
